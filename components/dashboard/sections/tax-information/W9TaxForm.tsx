...
export const getW9TaxFormValuesSchema = isIndividual =>
  BaseFormSchema.merge(
    z.object({
      taxIdNumberType: z.enum(['SSN', 'EIN']),
      taxIdNumber: z.string().min(9).max(11),
      accountNumbers: z.string().or(z.literal('')).optional(),
      ...
      ...(isIndividual
        ...
        : {
            ...
            exemptPayeeCode: z.string().or(z.literal('')).optional(),
            fatcaExemptionCode: z.string().or(z.literal('')).optional(),
          }),
    }),
  );
    ...
    <div className="flex flex-col gap-y-4">
        ...
        {({ field }) => (
          <div className="mt-2 flex items-center space-x-2">
            ...
            <Button
              ...
              onClick={() => setFieldValue(field.name, 'EIN')}
            >
              EIN
            </Button>
          </div>
      ...
      <div className="mt-4 flex items-center gap-x-2">
        <label className="text-sm font-normal leading-normal">
          <Checkbox
            className="mr-2"
            name="hasConfirmedTOS"
            checked={formik.values.hasConfirmedTOS}
            onCheckedChange={checked => formik.setFieldValue('hasConfirmedTOS', checked === true)}
          />
